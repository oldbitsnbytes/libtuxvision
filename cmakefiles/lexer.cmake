...
set(HEADERS
    ...
    ${TARGET_DIR}/token_info.h
    ${TARGET_DIR}/default_tokens_reference.hcc
    ${TARGET_DIR}/lexer.h
...
# static .a should have been put into the current project archive file (libtea++.io.a). So no need to link again with luss.a in the other project.
target_link_libraries(${WORK} ${CMAKE_DL_LIBS} utility sqlite3)
