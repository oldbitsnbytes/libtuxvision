...
target_link_libraries(${TARGETNAME} ${CMAKE_DL_LIBS} main sqlite3)

add_dependencies(${WORK} main)
...
add_custom_command(
    ...
    COMMAND rm -vrf ${CMAKE_INSTALL_PREFIX}/include/${TARGET_DIR} ${CMAKE_INSTALL_PREFIX}/lib/${TARGETNAME}* || echo Nothing in install_manifest.txt to be uninstalled!
)
