...
/**
 * @brief A class for robust string manipulation and formatting, offering a variety of utility methods and overloaded operators.
 */
class  string final
{
    std::string _d_;
public:
    ...
    [[nodiscard]] auto len() const { return _d_.length(); }
