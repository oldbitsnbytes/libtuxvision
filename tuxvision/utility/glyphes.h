...
struct  glyph
{
    ...
    static constexpr T c_upcircle              = "󰁟  ";
    static constexpr T c_right_towards_up_arrow  = "󱞽 ";
    static constexpr T c_left_towards_up_arrow   = " ";
    static constexpr T c_keyboard              = " "; // Keyboard Glyphe
    static constexpr T c_mouse                 = "󰍽 "; // Mouse
    static constexpr T c_label                 = "󰌕 "; // label/tag
    static constexpr T c_tag                   = "󰓹 "; // tag
    ...
    static constexpr type right_towards_up_arrow  = 112;
    static constexpr type left_towards_up_arrow   = 113;
    static constexpr type keyboard           = 114;
    static constexpr type mouse              = 115;
    static constexpr type label              = 116;
    static constexpr type tag                = 117;
